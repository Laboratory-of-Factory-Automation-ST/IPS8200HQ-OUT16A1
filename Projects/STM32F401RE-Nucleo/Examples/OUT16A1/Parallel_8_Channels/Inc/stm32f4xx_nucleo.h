...
/** @defgroup STM32L4XX_NUCLEO_LOW_LEVEL_Exported_Constants STM32F4XX_NUCLEO LOW LEVEL Exported Constants
  * @{
  */
...
/** @defgroup STM32F4XX_NUCLEO_LOW_LEVEL_Exported_Variables STM32F4XX_NUCLEO LOW LEVEL Exported Variables
  * @{
  */
