...
/** @defgroup STM32F4XX_NUCLEO_CONFIG STM32F4XX_NUCLEO Config
  * @{
  */

/** @defgroup STM32F4XX_NUCLEO_CONFIG_Exported_Constants STM32F4XX_NUCLEO Config Exported Constants
  * @{
  */
/* COM Feature define */
