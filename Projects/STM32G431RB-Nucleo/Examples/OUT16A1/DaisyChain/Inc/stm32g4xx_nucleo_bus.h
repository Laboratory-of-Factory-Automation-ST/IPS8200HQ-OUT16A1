...
/** @addtogroup STM32G4XX_NUCLEO_BUS_Exported_Constants STM32G4XX_NUCLEO BUS Exported Constants
  * @{
  */
...
/** @addtogroup STM32G4XX_NUCLEO_BUS_Exported_Types STM32G4XX_NUCLEO BUS Exported Types
  * @{
  */
