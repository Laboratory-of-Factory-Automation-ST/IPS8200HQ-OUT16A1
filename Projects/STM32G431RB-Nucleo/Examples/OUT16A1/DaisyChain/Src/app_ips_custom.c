...
void IPS_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  {
    (void)OUT16_RELAY_PwmTick_DaisyChain();
  }
  else if (htim == &IPS_GUARD_TIM_Handle)
  {
    (void)OUT16_RELAY_GuardTimerTick_DaisyChain();
  }
...
void custom_app_init(void)
{
  ...
  Device_System_CtrlMode[1U] = (uint8_t)OUT16_UNDEF_CTRL_MODE;
  Device_System_State_bitmap = 0U;
  Device_System_WdMode[0U] = 0U;
  Device_System_WdMode[1U] = 0U;
  IPS_NbInstances = 0U;
  ...
  (void)OUT16_RELAY_Init(OUT16_BOARD_1, OUT16_RELAY_CHIP_ID, IPS_NbDevices, &relayInitParam);
...
/**
  * @brief IPS Relay custom operations execution function in Daisy Chain mode
  * @retval None
  */
  ...
  if (gButtonPressed != 0U)
  {
    ...
    switch (gStep)
    {
      case 0:
        ...
        (void)OUT16_RELAY_SetOperatingMode(OUT16_BOARD_1, &ctrlMode);

        /* Enable Daisy Chain configuration management */
        (void)OUT16_RELAY_EnableDaisyChain(OUT16_BOARD_0, 1U);
        (void)OUT16_RELAY_EnableDaisyChain(OUT16_BOARD_1, 1U);

        /* Enable the outputs in all boards (Common OUT_EN) */
        (void)OUT16_RELAY_SetCtrlPinStatus(OUT16_BOARD_0, OUT16_RELAY_0_OUT_EN, 1U);

        /* Set chan 0, 3, 4, 7 in board 0 */
        /* Set chan 1, 2, 5, 6 in board 1 */
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN1, 1U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN2, 1U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN4, 1U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN3, 1U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN5, 1U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN6, 1U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN8, 1U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN7, 1U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);
        break;
      ...
      case 1:
        ...
        /* Set chan 0, 3, 4, 7 in board 1 */
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN2, 1U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN1, 1U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN3, 1U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN4, 1U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN6, 1U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN5, 1U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN7, 1U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN8, 1U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);
        break;
      ...
      case 2:
        ...
        /* Clear chan 2, 3, 6, 7 in board 1 */
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN1, 0U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN3, 0U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN2, 0U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN4, 0U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN5, 0U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN7, 0U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN6, 0U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN8, 0U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);
        break;
      ...
      case 3:
        ...
        /* Clear chan 0, 1, 4, 5 in board 1 */
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN3, 0U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN1, 0U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN4, 0U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN2, 0U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN7, 0U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN5, 0U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);

        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_0, OUT16_RELAY_0_IN8, 0U);
        (void)OUT16_RELAY_QueueChannelStatus(OUT16_BOARD_1, OUT16_RELAY_1_IN6, 0U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);
        break;

      case 4:
        /*********** Step 4 ************/
        /* Set channels to 0xF0 (last four ON) in board 0 */
        /* Set channels to 0x0F (first four ON) in board 1 */
        (void)OUT16_RELAY_QueueAllChannelStatus(OUT16_BOARD_0, 0xF0U);
        (void)OUT16_RELAY_QueueAllChannelStatus(OUT16_BOARD_1, 0x0FU);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);
        break;

      case 5:
        /*********** Step 5 ************/
        /* Set channels to 0x0F (first four ON) in board 0 */
        /* Set channels to 0xF0 (last four ON) in board 1 */
        (void)OUT16_RELAY_QueueAllChannelStatus(OUT16_BOARD_0, 0x0FU);
        (void)OUT16_RELAY_QueueAllChannelStatus(OUT16_BOARD_1, 0xF0U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);
        break;

      case 6:
        /*********** Step 6 ************/
        /* Clear all channels in all boards */
        (void)OUT16_RELAY_QueueAllChannelStatus(OUT16_BOARD_0, 0U);
        (void)OUT16_RELAY_QueueAllChannelStatus(OUT16_BOARD_1, 0U);
        (void)OUT16_RELAY_SendQueuedChannelStatus(OUT16_BOARD_0);
        ...
        /* Set frequency for 2Hz for chan 1, 3, 5, 7 in board 1 */
        (void)OUT16_RELAY_SetChannelFreq(OUT16_BOARD_1, OUT16_RELAY_1_IN2, 20U);
        (void)OUT16_RELAY_SetChannelFreq(OUT16_BOARD_1, OUT16_RELAY_1_IN4, 20U);
        (void)OUT16_RELAY_SetChannelFreq(OUT16_BOARD_1, OUT16_RELAY_1_IN6, 20U);
        (void)OUT16_RELAY_SetChannelFreq(OUT16_BOARD_1, OUT16_RELAY_1_IN8, 20U);
        ...
        /* Set frequency for 1Hz for chan 0, 2, 4, 6 in board 1 */
        (void)OUT16_RELAY_SetChannelFreq(OUT16_BOARD_1, OUT16_RELAY_1_IN1, 10U);
        (void)OUT16_RELAY_SetChannelFreq(OUT16_BOARD_1, OUT16_RELAY_1_IN3, 10U);
        (void)OUT16_RELAY_SetChannelFreq(OUT16_BOARD_1, OUT16_RELAY_1_IN5, 10U);
        (void)OUT16_RELAY_SetChannelFreq(OUT16_BOARD_1, OUT16_RELAY_1_IN7, 10U);
        ...
        /* Set duty cycle at 25% for chan 1, 3, 5, 7 in board 1 */
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN2, 25U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN4, 25U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN6, 25U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN8, 25U);
        ...
        /* Set duty cycle at 50% for chan 0, 2, 4, 6 in board 1 */
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN1, 50U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN3, 50U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN5, 50U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN7, 50U);

        /* Start PWM mode all chans in all boards */
        for (chanId = OUT16_RELAY_0_IN1; chanId <= OUT16_RELAY_0_IN8; chanId++)
        {
          (void)OUT16_RELAY_SetPwmEnable(OUT16_BOARD_0, chanId, 1U);
          (void)OUT16_RELAY_SetPwmEnable(OUT16_BOARD_1, chanId, 1U);
        }
        break;
      ...
      case 7:
        ...
        /* Set duty cycle at 50% for chan 1, 3, 5, 7 in board 1 */
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN2, 50U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN4, 50U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN6, 50U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN8, 50U);
        break;
      ...
      case 8:
        ...
        /* Set duty cycle at 75% for chan 0, 2, 4, 6 in board 1 */
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN1, 75U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN3, 75U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN5, 75U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN7, 75U);
        break;
      ...
      case 9:
        ...
        /* Set duty cycle at 100% for chan 1, 3, 5, 7 in board 1 */
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN2, 100U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN4, 100U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN6, 100U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN8, 100U);
        break;
      ...
      case 10:
        ...
        /* Set duty cycle at 100% for chan 0, 2, 4, 6 in board 1 */
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN1, 100U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN3, 100U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN5, 100U);
        (void)OUT16_RELAY_SetChannelDc(OUT16_BOARD_1, OUT16_RELAY_1_IN7, 100U);
        break;

      case 11:
      default:
        /*********** Step 11 ************/
        /* Stop PWM mode all chans in all boards */
        for (chanId = OUT16_RELAY_0_IN1; chanId <= OUT16_RELAY_0_IN8; chanId++)
        {
          (void)OUT16_RELAY_SetPwmEnable(OUT16_BOARD_0, chanId, 0U);
          (void)OUT16_RELAY_SetPwmEnable(OUT16_BOARD_1, chanId, 0U);
        }

        /* Disable the outputs in all boards */
