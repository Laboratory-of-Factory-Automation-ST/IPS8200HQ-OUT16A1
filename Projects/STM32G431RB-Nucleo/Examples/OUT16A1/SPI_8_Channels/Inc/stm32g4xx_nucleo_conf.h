...
/** @addtogroup STM32G4XX_NUCLEO_CONFIG STM32G4XX_NUCLEO Config
  * @{
  */

/** @addtogroup STM32G4XX_NUCLEO_CONFIG_Exported_Constants STM32G4XX_NUCLEO Config Exported Constants
  * @{
  */
/* COM Feature define */
